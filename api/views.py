...
# Get all the students from the database and return it in JSON format with FBV GET,POST
#===================Function based views (FBVs)=====================
@api_view(['GET','POST'])
def studentsView(request):
    
    if request.method == "GET":
       # get all the data from the student table in the database
...
class EmployeeViewset(viewsets.ModelViewSet):
    queryset = Employee.objects.all()
    serializer_class = EmployeeSerializer
    pagination_class = pagination.LimitOffsetPagination(limit=2)
